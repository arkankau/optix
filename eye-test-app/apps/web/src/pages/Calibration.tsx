...
export default function Calibration() {
  ...
  const handleComplete = () => {
    ...
    ProgressionEvents.calibrationComplete();
  };

  // Expose calibration complete function globally for agent to call
  useEffect(() => {
    (window as any).completeCalibration = handleComplete;
    return () => {
      delete (window as any).completeCalibration;
    };
  }, [cardWidthPx, distance]);
