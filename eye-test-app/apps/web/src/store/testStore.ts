...
interface TestState {
  ...
  currentTestLine: number; // Track current line in sphere test for UI sync
  ...
  setCurrentTestLine: (line: number) => void;
  reset: () => void;
}
...
export const useTestStore = create<TestState>((set) => ({
  ...
  setCurrentTestLine: (line) => set({ currentTestLine: line }),
