...
exports.WavefrontEngine = void 0;
/**
...
class WavefrontEngine {
     ...
     */
    static isNoRx(sphere_D, cylinder_D) {
     ...
     */
    static computeWavefront(params, pupilRadiusMm = 3.0) {
     ...
     */
    static wavefrontToPSF(wavefront, params) {
...
exports.WavefrontEngine = WavefrontEngine;
