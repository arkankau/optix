 ...
 */
function dft1D(signal: Float32Array): { real: Float32Array; imag: Float32Array } {
 ...
 */
function idft1D(real: Float32Array, imag: Float32Array): Float32Array {
  const N = real.length;
 ...
 */
export function compute1DFFT(signal: Float32Array): { real: Float32Array; imag: Float32Array } {
 ...
 * Compute 1D IFFT
 */
export function compute1DIFFT(real: Float32Array, imag: Float32Array): Float32Array {
 ...
 */
export function complexConjugate(real: Float32Array, imag: Float32Array, length: number): { real: Float32Array; imag: Float32Array } {
 ...
 */
export function magnitudeSquared(real: Float32Array, imag: Float32Array, length: number): Float32Array {
 ...
 */
export function computeWienerFilter1D(
  hReal: Float32Array,
  hImag: Float32Array,
  lambda: number
): { real: Float32Array; imag: Float32Array } {
